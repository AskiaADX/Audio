(function () {
   ...
   */
   ...
   /**
   * Creates a new instance of the audio
   *
   * @param {Object} options Options of the Audio
   ...
   */
   function Audio(options) {
      ...
      this.mobile = options.mobile || 0;
       
      var myAudio = document.getElementById("adc_" + this.instanceId + "_audio");
      var myObject = document.getElementById("adc_" + this.instanceId + "_object");
       
       if (!this.controls && this.autoplay) {
           if (myAudio.addEventListener) {
               disableRightClick(myAudio);
           } else {
      ...
      if (this.autosubmit && this.javascriptSupport) {
        addEvent(myAudio,"ended",myHandler);
      }

       if (!this.controls && this.mobile) {
           addEvent(document.getElementById("adc_" + this.instanceId + "_play"),"touchstart",function (e) {
